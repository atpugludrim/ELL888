...
{\bf  {\color{blue} {Kernel Optimization for Minimal Complexity Machines (MCMs)}}}
					\\
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.7\linewidth]{/home/mridul/Desktop/iitd_rishi_laptop/backups/ELL888/Figure_0.png}
    \caption{\label{fig:data}Training Data}
\end{figure}
\begin{figure}[!htbp]
    \centering
    \subfloat[Unoptimized RBF Kernel]{
        \includegraphics[width=.4\linewidth]{/home/mridul/Desktop/iitd_rishi_laptop/backups/ELL888/Figure_1.png}}
    \subfloat[Optimized Kernel]{
        \includegraphics[width=.4\linewidth]{/home/mridul/Desktop/iitd_rishi_laptop/backups/ELL888/Figure_2.png}}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.7\linewidth]{/home/mridul/Desktop/iitd_rishi_laptop/backups/ELL888/Figure_4.png}
    \caption{\label{fig:data}Training Data}
\end{figure}
\begin{figure}[!htbp]
    \centering
    \subfloat[Unoptimized RBF Kernel]{
        \includegraphics[width=.4\linewidth]{/home/mridul/Desktop/iitd_rishi_laptop/backups/ELL888/Figure_5.png}}
    \subfloat[Optimized Kernel]{
        \includegraphics[width=.4\linewidth]{/home/mridul/Desktop/iitd_rishi_laptop/backups/ELL888/Figure_6.png}}
    \caption{\label{fig:kernelPCA}Training Data mapped through kernels and then projected
    to two dimensional Euclidean space through kernel PCA.}
\end{figure}\par
...
\afterpage{\clearpage}
	...
	\begin{thebibliography}{10}
        \bibitem{amari}
            Amari SI, Wu S. 
            \newblock{\em Improving support vector machine classifiers by modifying kernel functions.}.
